  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Create New Course Offering</h1>
          <p className="text-muted-foreground">
            Set up a new WSET course template that can be used to schedule multiple sessions
          </p>
        </div>
      </div>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Select value={formData.wset_level} onValueChange={(value) => setFormData(prev => ({ ...prev, wset_level: value }))}>
                  ...
                  <SelectContent>
                    <SelectItem value="1">Level 1 - Award in Wines</SelectItem>
                    <SelectItem value="2">Level 2 - Intermediate Award in Wines</SelectItem>
                    <SelectItem value="3">Level 3 - Advanced Certificate in Wines</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div>
                ...
                <Input
                  id="name"
                  required
                  placeholder="e.g., WSET Level 2 Award in Wines - Online Course"
                  value={formData.name}
              ...
              <div>
                ...
                <Textarea
                  ...
                  required
                  rows={4}
                  placeholder="Comprehensive description of the course content, objectives, and what students will learn..."
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                ...
                {!formData.active && <Badge variant="secondary">Inactive</Badge>}
              </div>
